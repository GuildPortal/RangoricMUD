...
(function ($, window) {
    ...
    signalR.accountHub = {
        _: {
            hubName: 'AccountHub',
            ignoreMembers: ['checkLogin', 'confirmAccount', 'createAccount', 'login', 'logout'],
            connection: function () { return signalR.hub; }
        },

        logout: function () {
            return invoke(this, "Logout", $.makeArray(arguments));
        },

        login: function (tLoginAccount) {
            return invoke(this, "Login", $.makeArray(arguments));
        },

        createAccount: function (tCreateAccount) {
            return invoke(this, "CreateAccount", $.makeArray(arguments));
        },

        confirmAccount: function (tConfirmAccountPageModel) {
            return invoke(this, "ConfirmAccount", $.makeArray(arguments));
        },

        checkLogin: function () {
            return invoke(this, "CheckLogin", $.makeArray(arguments));
        }
    };

    signalR.administrationHub = {
        _: {
            hubName: 'AdministrationHub',
            ignoreMembers: ['testMethod'],
            connection: function () { return signalR.hub; }
        },

        testMethod: function () {
            return invoke(this, "TestMethod", $.makeArray(arguments));
        }
    };
    ...
    signalR.gameHub = {
        _: {
            hubName: 'GameHub',
            ignoreMembers: ['createGame', 'getAll', 'getGame'],
            connection: function () { return signalR.hub; }
        },

        createGame: function (tCreateGameModel) {
            return invoke(this, "CreateGame", $.makeArray(arguments));
        },

        getAll: function () {
            return invoke(this, "GetAll", $.makeArray(arguments));
        },

        getGame: function (tGetGameModel) {
            return invoke(this, "GetGame", $.makeArray(arguments));
        }
    };
